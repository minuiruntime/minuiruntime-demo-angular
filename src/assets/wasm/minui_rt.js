 ...
 * @returns {string}
 */
export function diff_html(a_json, b_json) {
    let deferred4_0;
    let deferred4_1;
    try {
        ...
        const ret = wasm.diff_html(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
...
const WasmStreamingRendererFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wasmstreamingrenderer_free(ptr >>> 0, 1));
...
export class WasmStreamingRenderer {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        WasmStreamingRendererFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmstreamingrenderer_free(ptr, 0);
    }
    /**
     ...
     */
    patches_applied() {
        const ret = wasm.wasmstreamingrenderer_patches_applied(this.__wbg_ptr);
        return ret >>> 0;
    }
    constructor() {
        const ret = wasm.wasmstreamingrenderer_new();
        this.__wbg_ptr = ret >>> 0;
        WasmStreamingRendererFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    html() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmstreamingrenderer_html(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    reset() {
        wasm.wasmstreamingrenderer_reset(this.__wbg_ptr);
    }
    /**
    ...
    feed_ai(output) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmstreamingrenderer_feed_ai(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    feed_json(json) {
        ...
        try {
            const ptr0 = passStringToWasm0(json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmstreamingrenderer_feed_json(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
if (Symbol.dispose) WasmStreamingRenderer.prototype[Symbol.dispose] = WasmStreamingRenderer.prototype.free;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('minui_rt_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
